...
class TabContent extends React.Component {
      ...
      .then(
        (result) => {
          ...
          for (var i = 0; i < result.length; i++) {
            ...
            date.push(
              result[i].date.toString().substr(4, 2) +
                "-" +
                result[i].date.toString().substr(6, 2)
            );
  ...
  render() {
    ...
    doughnut_chart_all.datasets[0].data = [
      ...
      <Container className="content">
          ...
          <Container fluid>
            <section className="panel panel-danger">
              <h2 className="panel-heading">
                Comparing State Orders with Number of Cases
              </h2>
              <p className="panel-body">
                These visualizations highlight the effects of Stay-At-Home
                orders in regards to the number of COVID-19 cases in Illinois.
              </p>
            </section>
            <Container fluid>
              <div className="spacing" />
        ...
        {this.props.activeTab.name === TabName[2] ? (
          <Container fluid>
            <section className="panel panel-danger">
              <h2 className="panel-heading">
                Comparing State Orders with Testing Conducted
              </h2>
              <p className="panel-body">
                These visualizations highlight the effects of Stay-At-Home
                orders in regards to the amount of testing conducted in
                Illinois.
              </p>
            </section>
            <Container fluid>
        ...
        {this.props.activeTab.name === TabName[3] ? (
          <Container fluid>
            <section className="panel panel-danger">
              <h2 className="panel-heading">
                Comparing State Orders with Unemployment Claims
              </h2>
              <p className="panel-body">
                These visualizations highlight the effects of Stay-At-Home
                orders in regards to the number of unemployment claims filed in
                Illinois.
              </p>
            </section>
            <Container fluid>
